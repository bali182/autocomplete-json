...
exports.defaultProviders = [new babelrc_presets_proposal_provider_1.default(), new babelrc_plugins_proposal_provider_1.default(), new file_proposal_provider_1.FileProposalProvider(tsconfig_json_files_proposal_provider_1.default), new file_proposal_provider_1.FileProposalProvider(package_json_files_proposal_provider_1.default), new file_proposal_provider_1.FileProposalProvider(package_json_directories_proposal_provider_1.default), new file_proposal_provider_1.FileProposalProvider(bower_json_files_proposal_provider_1.default), new file_proposal_provider_1.FileProposalProvider(composer_json_php_file_or_folder_proposal_provider_1.default), new file_proposal_provider_1.FileProposalProvider(composer_json_any_file_proposal_provider_1.default), new semver_dependency_proposal_provider_1.SemverDependencyProposalProvider(package_json_dependency_config_1.default), new semver_dependency_proposal_provider_1.SemverDependencyProposalProvider(composer_json_dependency_config_1.default)];
exports.defaultSchemaProviders = [tsconfig_json_schema_proposal_provider_1.default, package_json_schema_proposal_provider_1.default, bower_json_schema_proposal_provider_1.default, babelrc_json_schema_proposal_provider_1.default, composer_json_schema_proposal_provider_1.default];