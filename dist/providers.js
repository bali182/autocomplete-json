...
var composer_json_schema_proposal_provider_1 = require('./providers/composer/composer-json-schema-proposal-provider');
...
exports.defaultProviders = [
    ...
    new file_proposal_provider_1.FileProposalProvider(composer_json_php_file_or_folder_proposal_provider_1.default),
    new file_proposal_provider_1.FileProposalProvider(composer_json_any_file_proposal_provider_1.default),
    new semver_dependency_proposal_provider_1.SemverDependencyProposalProvider(package_json_dependency_config_1.default),
    new semver_dependency_proposal_provider_1.SemverDependencyProposalProvider(composer_json_dependency_config_1.default)
];
exports.defaultSchemaProviders = [
    ...
    composer_json_schema_proposal_provider_1.default
];
